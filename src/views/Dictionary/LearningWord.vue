    ...
    <div class="learning-card">
      <div class="card-info">
        <div class="review">
          ...
          <div class="card-info-num">{{ reviewWord }}</div>
        </div>
        <div class="learn">
          <div class="card-info-text">新学</div>
          <div class="card-info-num">{{ learnWord }}</div>
        </div>
        <div class="time">
          <div class="card-info-text">学习时长</div>
          <div class="card-info-num">{{}}</div>
        </div>
      </div>
      <div class="word-info">
...
<script setup lang="ts">
  ...
  let reviewList = ref<Array<Dic.LearnCardInfo>>();
  let learnList = ref<Array<Dic.LearnCardInfo>>();
  let curWord = ref<Dic.WordInfo>();

  onMounted(async () => {
    const res = await api.dictionary.getTodayWordList();
    reviewList.value = res.review;
    learnList.value = res.learn;
